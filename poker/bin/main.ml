...
let bot_bet (gm : Game.t) (pl : Player.t) =
  ...
  | Bot 1 -> begin (*A balanced player, a little insecure and annoying*)
    match rand with
  | 0 -> 
  print_endline "Bot 1 says: 'I call your bet (if you bet it bet the same, or checks if you checked.)";
...
| 7 -> 
  ...
  Game.fold_player gm pl
| 8 -> 
  print_endline "Bot 2 says: 'I call your bet (if you bet it bet the same, or checks if you checked.)"; 
...
match rand with
| 0 -> 
  print_endline "Bot 3 says: 'I call your bet (if you bet it bet the same, or checks if you checked.)"; 
...
match rand with
| 0 -> 
  print_endline "Bot 4 says: 'I call your bet (if you bet it bet the same, or checks if you checked.)"; 
